...
class ResultsSubstate extends MusicBeatSubstate
{
	...
	public function new(song:String, ratingName:String, score:Int, accuracy:Int, misses:Int, noteshit:Int, sick:Int, good:Int, bad:Int, shit:Int, maxcombo:Int, bplay:Bool, pmode:Bool)
	{
		...
		bottomText.setFormat(Paths.font("vcr.ttf"), 18, FlxColor.WHITE, CENTER);
		...
		songText1.setFormat(Paths.font("vcr.ttf"), 30, FlxColor.WHITE, CENTER);
		...
		songText2.setFormat(Paths.font("vcr.ttf"), 45, FlxColor.WHITE, CENTER);
		...
		scoreText1.setFormat(Paths.font("vcr.ttf"), 20, FlxColor.WHITE, CENTER);
		...
		scoreText2.setFormat(Paths.font("vcr.ttf"), 40, FlxColor.WHITE, CENTER);
		...
		miscText.setFormat(Paths.font("vcr.ttf"), 27, FlxColor.WHITE, CENTER);
        ...
        if(bplay){ //cheater
		    ...
		    botplayText.setFormat(Paths.font("vcr.ttf"), 45, FlxColor.WHITE, CENTER);
        ...
        if(pmode){
            ...
            practiceText.setFormat(Paths.font("vcr.ttf"), 35, FlxColor.WHITE, RIGHT);
